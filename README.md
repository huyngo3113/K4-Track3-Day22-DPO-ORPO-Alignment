...
[![Open T4 in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/antongduy2307/K4-Track3-Day22-TongDuyAn-2A202601995/blob/main/colab/Lab22_DPO_T4.ipynb)
...
```bash
git clone https://github.com/antongduy2307/K4-Track3-Day22-TongDuyAn-2A202601995.git
cd K4-Track3-Day22-TongDuyAn-2A202601995
...
1. **Fork hoặc copy repo này lên GitHub account của bạn**, set repo **public**.
   ```bash
   git init -b main
   git remote add origin https://github.com/antongduy2307/K4-Track3-Day22-TongDuyAn-2A202601995.git
   ```
